...
const OrganizerCard: FunctionComponent<OrganizerCardProps> = ({ firstName, lastName, profilePicture, eventName }) => {
    return (
        <Card className="flex flex-col justify-between px-8 py-4 w-80 h-40 cursor-pointer">
            <div className="flex justify-between items-center w-full">
                ...
                <div className="relative w-16 h-16 overflow-hidden">
                    <Image src="/images/qr-code.png" alt="QR Code" quality={100} fill className="object-center object-cover"/>
                </div>
            </div>
