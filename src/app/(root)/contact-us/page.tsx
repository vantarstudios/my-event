...
const ContactUsPage: NextPage = () => {
    return (
        <PageContainer>
            <div className="relative flex gap-[10vh] w-full">
                <div className="flex flex-col gap-[5vh] w-1/2">
                    ...
                    <p>
                        Create, organize and manage your events with your team. Plan how every task and activities will
                        be
                        done and by who before, during and after your events. Use social medias and the eventMedia app
                        to
